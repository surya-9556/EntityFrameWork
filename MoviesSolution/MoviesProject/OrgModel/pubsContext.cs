...
namespace MoviesProject.OrgModel
{
    public partial class pubsContext : DbContext
    {
        ...
        public virtual DbSet<Employee101> Employee101s { get; set; }
        public virtual DbSet<Employee102> Employee102s { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("server=DESKTOP-87C5QHV;Integrated security=true; Initial catalog=pubs;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Employee1>(entity =>
            {
                ...
                entity.HasOne(d => d.Manager)
                    ...
                    .HasConstraintName("empManageId");
            });

            modelBuilder.Entity<Employee101>(entity =>
            {
                entity.ToTable("Employee101");
            ...
            modelBuilder.Entity<Employee102>(entity =>
            {
                entity.ToTable("Employee102");
